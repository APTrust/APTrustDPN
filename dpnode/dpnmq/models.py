...
VALID_AVAILABLE_BODY          = MessageSchema({"message_name": "replication-available-reply",
                                        "message_att" : "ack",
                                        "protocol"    : Or("https", "rsync")})
                                        
VALID_NOT_AVAILABLE_BODY      = MessageSchema({"message_name": "replication-available-reply",
                                        "message_att" : "nak"})
                      
VALID_REPLY_INIT_QUERY_BODY   = MessageSchema({"message_name"      : "replication-init-query",
