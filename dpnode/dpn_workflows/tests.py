...
class RecieveAvailableWorkflowTest(TestCase):
    ...
    def test_recieve_available_workflow(self):
        ...
        gAction = recieve_available_workflow(**gData)
        ...
        self.assertRaises(ValidationError, recieve_available_workflow,
                          **fData)
        ...
        self.assertRaises(DPNWorkflowError, recieve_available_workflow,
                          **xData)
